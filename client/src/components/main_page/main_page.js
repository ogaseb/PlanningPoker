...
class MainPage extends Component {
  ...
  handleLogin = () => {
    const {cookies, history: {push}, store: {userStore: {loginUser}}} = this.props;

    let win = window.open("http://localhost:3001/login/google", "GoogleAuth", 'width=400, height=600')
    ...
    function receiveMessage(event) {
      ...
      cookies.set('userLoginData', event.data, {path: '/', expires: nextWeek()});
